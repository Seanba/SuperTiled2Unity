...
{
    // fixit - I shouldn't really call this an atlas builder anymore (leave a blank, deprecated, file)
    public class AtlasBuilder
    {
        ...
        public AtlasBuilder(TiledAssetImporter importer, SuperTileset tilesetScript)
        {
        ...
        {
            var atlasTile = new AtlasTile() { Index = index, SourceTexture2D = texSource, SourceRectangle = rcSource, IsTransparent = isTransparent };
